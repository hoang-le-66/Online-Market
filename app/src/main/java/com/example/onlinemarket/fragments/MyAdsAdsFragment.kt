...
import com.example.onlinemarket.databinding.FragmentMyAdsAdsBinding
...
class MyAdsAdsFragment : Fragment() {
    ...
    private lateinit var myAdsAdsBinding: FragmentMyAdsAdsBinding
    ...
    override fun onCreateView(
        ...
        myAdsAdsBinding = FragmentMyAdsAdsBinding.inflate(inflater, container, false)
        return myAdsAdsBinding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        myAdsAdsBinding.searchEdt.addTextChangedListener(object : TextWatcher{
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                //call this func whenever user type letter, search based on what user typing
                try {
    ...
    private fun loadAds(){
        Log.d(TAG, "loadAds: ")
        //init adArrayList before start adding data into
        ...
        ref.orderByChild("uid").equalTo(firebaseAuth.uid)
            .addValueEventListener(object: ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    myAdsAdsBinding.adsRv.adapter = adapterAd
                }
